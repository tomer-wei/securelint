...
const rule = {
    meta: {
        ...
        messages: {
            commandInjection: "Potential command injection: dynamic value passed to '{{name}}()'. Use execFile/spawn with argument arrays instead of exec with string commands.",
        },
        schema: [],
    },
    create(context) {
