...
const rule = {
    meta: {
        ...
        messages: {
            noInnerHtml: "Potential XSS: assigning to '{{property}}' with dynamic content is unsafe. Use textContent or a sanitization library.",
            noDangerouslySetInnerHTML: "Potential XSS: 'dangerouslySetInnerHTML' bypasses React's XSS protection. Sanitize input with a library like DOMPurify.",
            noDocumentWrite: "Potential XSS: 'document.write()' with dynamic content is unsafe.",
        },
        schema: [],
    },
    create(context) {
